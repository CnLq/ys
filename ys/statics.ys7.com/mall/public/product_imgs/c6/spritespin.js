...
(function($) {
   ...
   * @example
   *      sourceArray('http://example.com/image_{frame}.jpg, { frame: [1, 3], digits: 2 })   *      // -> ['http://example.com/image_01.jpg', '../../../../../example.com/image_02.jpg'/*tpa=http://example.com/image_02.jpg*/, '../../../../../example.com/image_03.jpg'/*tpa=http://example.com/image_03.jpg*/ ]
   * @param path
   * @param opts
   * @returns {Array}
   */
...
/** @livi  start*/    
    if (obj === "next"){
            SpriteSpin.updateFrame($('#panorama-example').data('spritespin'), m);
            //SpriteSpin.updateFrame( $('#sprite-sheet-example').data('spritespin'), attr[i]);
           m=m+100;
    }   
    if (obj === "prev"){
            SpriteSpin.updateFrame($('#panorama-example').data('spritespin'), m);
